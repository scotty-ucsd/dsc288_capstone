...
TODO: Preserve physics; no changes needed
note: make sure lag features don't propagate nan just because 1 cell is nan in a 30 min window
- add another column n_points that tracks the number of points used for lag features
"""
